//create the constructor Bpad for the class bottompad
function Bpad(x, y) {
    //initialisation code

    //create the draw function to give us the draw method
    //it accepts one parameter which is the context from the canvas it is drawn on
    Bpad.prototype.draw = function (context) {
        ...
        context.moveTo(-735, -10);
        context.lineTo(735, -10);
        context.lineTo(735, 10);
        context.lineTo(-735, 10);
        //close the path
        context.closePath();
