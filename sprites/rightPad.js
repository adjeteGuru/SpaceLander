//create the constructor Rpad for the class pad
function Rpad(x, y) {
    //initialisation code
    
    //create the draw function to give us the draw method
    //it accepts one parameter which is the context from the canvas it is drawn on
    Rpad.prototype.draw = function (context) {
        ...
        context.lineTo(5, 735/*400*/);
        context.lineTo(-10, 735 /*400*/);
        //close the path
        context.closePath();
        context.fill();
